...
Output: `dist/scott2026-zenodo.zip`

## Upload

1. [zenodo.org/deposit/new](https://zenodo.org/deposit/new)
2. Upload `dist/scott2026-zenodo.zip`
...
```text
Ericson, L. W. (2026). A Lean 4 Formalization of Interpreting Lambda Calculus
in Domain-Valued Random Variables (CSL 2026) (Version 0.1.0) [Software]. Zenodo.
https://doi.org/10.5281/zenodo.XXXXXXX
```

Related: https://github.com/catskillsresearch/scott2026
