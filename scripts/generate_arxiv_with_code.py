...
# Library files in dependency order (matches Scott2026.lean import order).
FILES = [
    "Scott2026.lean",
...
def main() -> None:
    ...
    parts.append(
        ...
        "`.lean` files in dependency order (`Scott2026.lean`).*\n\n"
    )
    parts.append(
    ...
    parts.append(
        "Files appear in `Scott2026.lean` import order. "
