...
Usage (from repo root):
  bash scripts/ocr_pdf_pipeline.sh Scott2026.pdf
  bash scripts/ocr_pdf_pipeline.sh Scott2026.pdf --pages 1-3
  bash scripts/ocr_pdf_pipeline.sh Scott2026.pdf --png-only
  bash scripts/ocr_pdf_pipeline.sh Scott2026.pdf --merge-only
  bash scripts/ocr_pdf_pipeline.sh Scott2026.pdf --status
"""
...
def main() -> None:
    ...
    ap.add_argument(
        ...
        type=Path,
        nargs="?",
        default=Path("Scott2026.pdf"),
        help="PDF name or path (default: Scott2026.pdf under sources/)",
    )
